...
Delimiter $$
Create function categorias_productos(id_producto int)
 returns varchar(70)
 reads sql data
 begin
...
select Marca,Modelo,Precio,categorias_productos(id_categoria) from productos;
...
/*¨Insertando mas datos a la tabla facturas*/
Insert into facturas(categoria_monotributo,direccion,precio_total,fecha) values ('C','Italia 720',20500,'2022/11/22');
Insert into facturas(categoria_monotributo,direccion,precio_total,fecha) values ('A','San Jose 9341',100450,'2022-11-22');
Insert into facturas(categoria_monotributo,direccion,precio_total,fecha) values ('B','Benito 2223',150000,'2022-11-22');
Insert into facturas(categoria_monotributo,direccion,precio_total,fecha) values ('B','Alcaldia 2945',4300,'2022-11-23');
Insert into facturas(categoria_monotributo,direccion,precio_total,fecha) values ('A','Miramar 3457',2000,'2022-11-23');