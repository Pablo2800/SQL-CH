...
/* -------------Insertando 4 registros nuevos--------------*/
start transaction;
insert into facturas values(2,'A','Rosas 1323',12500,'2022/11/23');
insert into facturas values(12,'B','Paso 0293',7500,'2022/11/23');
insert into facturas values(13,'D','Chile 9231',2000,'2022/11/23');
insert into facturas values(14,'D','Corrientes 983',8000,'2022/11/23');
update facturas set id_factura=15 where id_factura=2;
/*---------Savepoint de primeros 4 registros ----------*/
savepoint cuatro_inserciones;
/* -------------Insertando 4 registros nuevos--------------*/
insert into facturas(categoria_monotributo,direccion,precio_total,fecha) values('A','Brasil 2901',13500,'2022/11/24');
insert into facturas(categoria_monotributo,direccion,precio_total,fecha)values('B','Araos 9256',6500,'2022/11/24');
insert into facturas(categoria_monotributo,direccion,precio_total,fecha)values('D','Almirante Brown 2947',31000,'2022/11/24');
insert into facturas(categoria_monotributo,direccion,precio_total,fecha)values('D','Corrientes 983',9000,'2022/11/24');
/*---------Savepoint de los 8 registros ----------*/
savepoint ocho_inserciones;
/*---------Eliminar el savepoint del 1 al 4--------*/
release savepoint cuatro_inserciones;